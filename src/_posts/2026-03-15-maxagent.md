...
But here is the key: you are going to let the AI both read and write your TODO
list.
...
This might be obvious to some, but I just wanted to convey that there is nothing
mysterious behind the idea of the Ralph loop, and you don't have to 'use their
repo' to do most of what it does. Just make a TODO list and tell Claude about
it.
...
There are reasons to not pass the entire todo list to the agent everytime so the
ralph json format can be useful for this, but worth just understanding the basic
toolkit
