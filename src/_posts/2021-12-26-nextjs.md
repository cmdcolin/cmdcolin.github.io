...
- Markdown driven, and can use MDX (edit 2022: I removed MDX, I disliked the
  complexity that it brought. Now all posts are plain markdown, parsed with
...
- [Example: you have to manually restore underlines on `<a>` elements if using tailwind CSS](https://stackoverflow.com/a/68853223/2129219)
...
To me it was surprising the extent that tailwind goes to unstyle the default
