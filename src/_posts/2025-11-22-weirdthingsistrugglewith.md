...
People frequently talk about "virtualizing" after when there's only like 100
items on the page when using React. Virtualization (simulating scrolling of a
datagrid and loading items on the fly using js for example) in my opinion is
generally a bad compromise with many negative user experience and should not be
used in most cases, your users will notice the awkwardness of it
