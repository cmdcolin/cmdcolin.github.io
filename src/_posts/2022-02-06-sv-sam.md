...
mapped reads (some use _de novo_ assembly) — but mapped-read methods are still
useful to know.
...
inversion, for example, may take 4 `VCF` records to express. I'm not aware of
many tools that work on the Breakend graph, and expect more will be needed to
truly support it.
