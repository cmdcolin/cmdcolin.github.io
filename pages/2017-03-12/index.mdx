...
really quickly. This was sort of naive idea for me to share in, so I'll
go through the way the project progressed
...
- learning about full text search in postgres with ts\_query\
