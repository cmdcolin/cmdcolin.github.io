...
tell you about viruses, trojan horses, malware, or spying.  I have
decided to employ a free open source scanner called
clamAV <https://www.clamav.net/>

ClamAV is the top choice for linux based OSs being free and open source
(GPL) virus scanner.
...
    [\@hourly](https://tmblr.co/mOKWMmBeJ1b_J7izaZpeYaQ) clamscan -ri
\~/ \| mail -v -s "clamscan results" your.email\@gmail.com  \>/dev/null
2\>&1
