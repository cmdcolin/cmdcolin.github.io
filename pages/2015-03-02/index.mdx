...
2.  Rendering screenshots to PDF. In JBrowse, this requires PhantomJS
    ...
    phantomjs rasterize.js
    "http://localhost/jbrowse/?data=sample\_data/json/volvox&tracklist=0"
    output.pdf "16in\*8in"
...
gmod.org/wiki/JBrowse\_Configuration\_Guide\#Rendering\_high\_resolution\_screenshots\_using\_PhantomJS
