...
extended CIGAR, with the `X` indicating mismatches and '=' indicating matches),
but I don't often see this.
...
Long reads offer a wide array of benefits for detecting SVs
...
This is code that determines the pair orientation from a single BAM record
